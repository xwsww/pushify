...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "active", "deleted", "suspended", name="github_installation_status"
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.Enum("active", "deleted", name="team_status"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("active", "paused", "deleted", name="project_status"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_project_github_installation_id"),
        "project",
        ["github_installation_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_project_repo_full_name"), "project", ["repo_full_name"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "container_status",
            sa.Enum(
                "running", "stopped", "removed", name="deployment_container_status"
            ),
            nullable=True,
        ),
        sa.Column(
            "status",
            sa.Enum("queued", "in_progress", "completed", name="deployment_status"),
            nullable=False,
        ),
        sa.Column(
            "conclusion",
        ...
        sa.Column(
            "trigger",
            sa.Enum("webhook", "user", "api", name="deployment_trigger"),
            nullable=False,
        ),
        sa.Column("created_by_user_id", sa.Integer(), nullable=True),
        sa.Column("created_at", sa.DateTime(), nullable=False),
    ...
    op.create_index(
        op.f("ix_deployment_branch"), "deployment", ["branch"], unique=False
    )
    op.create_index(
        op.f("ix_deployment_commit_sha"), "deployment", ["commit_sha"], unique=False
    )
    op.create_index(
        op.f("ix_deployment_concluded_at"), "deployment", ["concluded_at"], unique=False
    )
    op.create_index(
        op.f("ix_deployment_created_at"), "deployment", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_deployment_project_id"), "deployment", ["project_id"], unique=False
    )
    op.create_index(
        op.f("ix_deployment_repo_full_name"),
        "deployment",
        ["repo_full_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_deployment_repo_id"), "deployment", ["repo_id"], unique=False
    )
    op.create_table(
        "domain",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "type",
            sa.Enum("route", "301", "302", "307", "308", name="domain_type"),
            nullable=False,
        ),
        sa.Column("environment_id", sa.String(length=8), nullable=True),
        sa.Column(
            "status",
            sa.Enum("pending", "active", "disabled", "failed", name="domain_status"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_domain_project_id"), "domain", ["project_id"], unique=False
    )
    op.create_table(
        "team_invite",
        sa.Column("id", sa.String(length=32), nullable=False),
        ...
        sa.Column(
            "role",
            sa.Enum("owner", "admin", "member", name="team_invite_role"),
            nullable=False,
        ),
        sa.Column(
            "status",
            sa.Enum("pending", "accepted", "revoked", name="team_invite_status"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_team_invite_email"), "team_invite", ["email"], unique=False
    )
    op.create_index(
        op.f("ix_team_invite_inviter_id"), "team_invite", ["inviter_id"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("owner", "admin", "member", name="team_member_role"),
            nullable=False,
        ),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.Column(
            "provider",
            sa.Enum("github", "google", name="identity_provider"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_user_identity_provider"), "user_identity", ["provider"], unique=False
    )
    op.create_index(
        op.f("ix_user_identity_provider_user_id"),
        "user_identity",
        ["provider_user_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_user_identity_user_id"), "user_identity", ["user_id"], unique=False
    )
    op.create_table(
        "alias",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "type",
            sa.Enum("branch", "environment", "environment_id", name="alias_type"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_alias_deployment_id"), "alias", ["deployment_id"], unique=False
    )
    op.create_index(
        op.f("ix_alias_previous_deployment_id"),
        "alias",
        ["previous_deployment_id"],
        unique=False,
    )
