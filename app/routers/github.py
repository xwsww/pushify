...
from models import User, UserIdentity, GithubInstallation, Project, Team
                    ...
                    try:
                        ...
                        if team:
                            ...
                            await NotificationService.create_for_team(
                                ...
                                team_id=team.id,
                                type="new_commit",
                                title=f"{project.name} · {branch} {sha_short}",
                                ...
                                dedupe_key=f"new_commit:{project.id}:{commit_data['sha']}",
                            )
                            await db.commit()
                    except Exception as e:
                        logger.error(
